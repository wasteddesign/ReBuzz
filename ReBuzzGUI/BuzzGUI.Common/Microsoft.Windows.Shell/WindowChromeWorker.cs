...
namespace Microsoft.Windows.Shell
{
    ...
    internal class WindowChromeWorker : DependencyObject
    {
        ...
        private void _SetWindow(Window window)
        {
            ...
            closeCommandBinding = new System.Windows.Input.CommandBinding(SystemCommands.CloseWindowCommand, _OnSystemCommandCloseWindow);
            window.CommandBindings.Add(closeCommandBinding);
        }

        System.Windows.Input.CommandBinding closeCommandBinding;

        private void _OnSystemCommandCloseWindow(object sender, System.Windows.Input.ExecutedRoutedEventArgs e)
        {
        ...
        {
            _window.CommandBindings.Remove(closeCommandBinding);
            closeCommandBinding = null;
