...
namespace Standard
{
    ...
    internal class SHARDAPPIDINFO
    {
        ...
        readonly object psi;    // The namespace location of the the item that should be added to the recent docs folder.
        [MarshalAs(UnmanagedType.LPWStr)]
        readonly string pszAppID;  // The id of the application that should be associated with this recent doc.
    }
    ...
    {
        readonly IntPtr psl;     // An IShellLink instance that when launched opens a recently used item in the specified 
