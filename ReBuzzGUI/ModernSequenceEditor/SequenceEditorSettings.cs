...
namespace WDE.ModernSequenceEditor
{
    ...
    public enum TrackWidts { Small = 80, Smaller = 100, Normal = 120, Larger = 160, Large = 200 };
    ...
    public class SequenceEditorSettings : Settings
    {
        ...
        [BuzzSetting(TrackWidts.Normal, Description = "Track Width.")]
        public TrackWidts TrackWidth { get; set; }
    }
}
