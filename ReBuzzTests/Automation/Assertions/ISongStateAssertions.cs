...
namespace ReBuzzTests.Automation.Assertions
{
    ...
    public class SongStateAssertions2(AbsoluteFilePath emptySongPath) : ISongStateAssertions //bug working name
    {
            ...
            IAdditionalInitialStateAssertions additionalAssertions)
        {
            ...
            songCore.SongName.Should().Be(emptySongPath.ToString());
