    ...
    public class MPEPattern
    {
        ...
        */
        ...
        internal MPEPatternColumn CreateNewColumn(IParameter param, int track, int columnIndex)
        {
            ...
            column.SetBeatCount(16);// (int)Editor.lengthBox.Value);
            column.SetRPB(rpb);
            column.UpdateLength();
        ...
        public void CreateDefaultColumns()
        {
            ...
            var lastPattern = PianorollEditor.MPEPatternsDB.GetPatterns().LastOrDefault();
            if (lastPattern != null)
            {
            ...
            else
            {
                ...
                foreach (var parAndTrack in pattern.Machine.AllParametersAndTracks())
                {
                    ...
                    column.SetBeatCount((int)PianorollEditor.BeatCount);
                    column.SetRPB(rpb);
                    column.UpdateLength();
        ...
        public void AddTrack(int trackNumber)
        {
            ...
            foreach (var trackColumn in trackColumns)
            {
                ...
                column.SetBeatCount(PianorollEditor.BeatCount); //.lengthBox.Value);
                column.SetRPB(rpb);
                column.UpdateLength();
        ...
        public MPEPattern(Editor editor, string name)
        {
