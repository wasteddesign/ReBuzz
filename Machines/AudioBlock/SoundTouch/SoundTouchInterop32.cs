...
namespace DSPLib.SoundTouch
{
    class SoundTouchInterop32
    {
        ...
        [DllImport(SoundTouchDllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr bpm_createInstance(int numChannels, int sampleRate);

        /// Destroys a BPM detector instance.
        /// 
        [DllImport(SoundTouchDllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void bpm_destroyInstance(IntPtr h);

        /// Feed 'numSamples' sample frames from 'samples' into the BPM detector.
        /// 
        [DllImport(SoundTouchDllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void bpm_putSamples(IntPtr h, [MarshalAs(UnmanagedType.LPArray)] float[] samples, uint numSamples);
        ...
        /// 
        [DllImport(SoundTouchDllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern float bpm_getBpm(IntPtr h);
    }
}